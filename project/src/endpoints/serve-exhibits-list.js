...
/** @function serveExhibitsList
 * 
 * Serves the template layout for exhibits list page with the necessary information
 *  - Supplies the navigation sidebar with the user information
 *  - Check for authorization
 *      - Admin role == 1 is redirected to an exhibits list
 ...
 **/
function serveExhibitsList(req, res) {
...
// EXPORT
module.exports = serveExhibitsList;